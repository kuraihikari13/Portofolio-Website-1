 ...
 *   https://datatables.net/download/#bs4/dt-1.11.3/kt-2.6.4/r-2.2.9/sb-1.3.0
 *
 * Included libraries:
 *   DataTables 1.11.3, KeyTable 2.6.4, Responsive 2.2.9, SearchBuilder 1.3.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs4/dt-1.11.3/kt-2.6.4/r-2.2.9/sb-1.3.0",
