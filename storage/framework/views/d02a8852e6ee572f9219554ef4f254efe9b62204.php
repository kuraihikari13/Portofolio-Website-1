...
<body>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="tables">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="employee">Karyawan</a></li>
                                <li class="nav-item"> <a class="nav-link" href="clock-in">Absensi</a></li>
                                <li class="nav-item"> <a class="nav-link" href="paycheck">Penggajian Karyawan</a></li>
                                <li class="nav-item"> <a class="nav-link" href="attendance-history">Histori Absensi</a></li>
                                <li class="nav-item"> <a class="nav-link" href="restock-request">Re-Stock Item</a></li>
                                <li class="nav-item"> <a class="nav-link" href="restock-history">Histori Re-Stock Item</a></li>
                            </ul>
                        </div>
                    </li>
    ...
    <script
    src="https://unpkg.com/bootstrap-table@1.19.1/dist/extensions/page-jump-to/bootstrap-table-page-jump-to.min.js"></script>
...
</html><?php /**PATH C:\xampp\htdocs\Momo\resources\views/dashboard-user/dashboard.blade.php ENDPATH**/ ?>